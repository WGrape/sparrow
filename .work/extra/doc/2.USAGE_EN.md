...
The sparrowtool is a companion toolkit for sparrow. In addition to the sparrowtool web dashboard functionality, it also provides advanced features such as image uploading and new service creation.
